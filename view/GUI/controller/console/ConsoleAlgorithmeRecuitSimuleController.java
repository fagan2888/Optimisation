...
public class ConsoleAlgorithmeRecuitSimuleController extends ConsoleController {

	public ConsoleAlgorithmeRecuitSimuleController(ConsoleView cv, Algorithme a) {
		super(cv, a);
	}
	...
	public void update(Observable o, Object arg) {
		consoleView.write(afficherEtat());
